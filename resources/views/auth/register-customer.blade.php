    ...
    <div class="wrapper">
        ...
        <section class="page-cover" id="cover-registration">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-title">Registration As Customer</h1>
                        <ul class="breadcrumb">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a href="{{ route('register.customer') }}" class="active btn btn-orange btn-block">Customer</a>
                        <a href="{{ route('register.service.provider') }}" class="btn btn-orange btn-block">Service
                            Provider</a>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
            ...
            <div id="registration" class="innerpage-section-padding">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="container">
                                <form method="post" action="{{ route('register.customer') }}" id="customerRegister">
                                    @csrf
                                    <div class="row">
                                        <h3>Registration</h3>
                                        ...
                                        <div class="custom-form custom-form-fields col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    placeholder="Security Question" name="security_question"  value="{{ old('security_question') }}" />
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    placeholder="Address Line 1" name="address_01"  value="{{ old('address_01') }}" />
                                                @error('address_01')
                                                   <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="other-links">
                                                <p class="link-line">Already Have An Account ? <a
                                        ...
                                        <div class="custom-form custom-form-fields col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <input type="password" class="form-control"
                                                    placeholder="Confrim Password" name="confirm_password" required  value="{{ old('confirm_password') }}" />
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    placeholder="Security Answer" name="security_answer"  value="{{ old('security_answer') }}" />
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    placeholder="Address Line 2" name="address_02"  value="{{ old('address_02') }}" />
                                                @error('address_02')
                                                   <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="State"
                                                    name="state" required  value="{{ old('state') }}" />
                                                @error('state')
                                                   <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
    ...
    <script>
     ...
     <script>
        function onSubmit(token) {
          document.getElementById("customerRegister").submit();
        }
      </script>
</body>
